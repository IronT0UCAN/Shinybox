...
''')
    ...
    def buy_pigeons(self):
        if self.shiny_things >= 100 and self.pigeons <= 9:
            self.shiny_things -= 100
            self.pigeons += 1
